...
outliers = st.text_input('Outlier Finder', 'apple, banana, melon, mango, car, truck').replace(" ", "")
...
cf1 = st.text_input('This is input for A in a to b is c to d', "Berlin", max_chars=15,label_visibility="hidden")
st.header("to")
cf2 = st.text_input('This is input for B in a to b is c to d', "Germany", max_chars=15,label_visibility="hidden")
st.header("is like")
cf3 = st.text_input('This is input for C in a to b is c to d', "Paris", max_chars=15,label_visibility="hidden")
st.header("to")
